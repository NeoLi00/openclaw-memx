...
- `vector_docs` and `vector_embeddings` expose canonical objects and evidence segments to FTS,
...
2. **Candidate Generation**
   ...
   abstractions, beliefs, and vector search. Hybrid retrieval combines lexical, embedding, and
   structured scoring.
