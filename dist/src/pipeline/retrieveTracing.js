...
export function summarizeBackgroundRecallBundle(bundle) {
    return {
...
export function sanitizeFocusedRecallQuery(rawQuery, focusedQuery) {
...
export function formatRecallProbeTrace(probe) {
...
export function formatRecallControllerTrace(controller) {
    return [
...
export function formatShallowRecallTrace(shallow) {
    return [
...
export function formatRecallQualityGateTrace(gate) {
    return [
...
export function buildRecallAuditPayload(options = {}) {
    if (!options.plan &&
        !options.probe &&
        !options.background &&
    ...
    return {
        ...
        shallow: options.shallow
            ? {
                ...
                routeSummaries: Object.fromEntries(Object.entries(options.shallow.routeSummaries).map(([routeType, summary]) => [
                    routeType,
                    {
        ...
        budgetPlan: options.budgetPlan
            ? {
                ...
                objectiveBudgets: Object.fromEntries(Object.entries(options.budgetPlan.objectiveBudgets).map(([routeType, budget]) => [
                    routeType,
                    {
        ...
        selectionTrace: options.selectionTrace
            ? {
                ...
                reserveSelections: Object.fromEntries(Object.entries(options.selectionTrace.reserveSelections).map(([routeType, entries]) => [
                    routeType,
                    entries.map((entry) => ({
...
export function compareEvidenceRowsChronologically(left, right) {
