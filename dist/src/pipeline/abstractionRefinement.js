...
function supportsSuggestedDisplayName(candidate) {
    return (candidate.abstractionType === "concept_candidate" ||
        candidate.abstractionType === "graph_hypothesis" ||
        candidate.abstractionType === "outcome_hypothesis");
}
export function eligibleForLlmRefinement(candidate) {
...
export function applyAbstractionRefinement(params) {
    ...
    const suggestedDisplayName = supportsSuggestedDisplayName(candidate) &&
    ...
    const displayNameChanged = suggestedDisplayName !== undefined &&
