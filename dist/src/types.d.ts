export declare const MEMORY_ROUTE_TYPES: readonly ["workflow", "factual", "explanatory", "temporal", "mixed", "unknown"];
export declare const MEMORY_CORRECTION_TIMEFRAMES: readonly ["current", "historical", "compare"];
export declare const MEMORY_CORRECTION_TARGET_KINDS: readonly ["state", "fact", "relation", "project_profile", "unknown"];
export declare const RECALL_QUERY_TIMEFRAMES: readonly ["current", "historical", "compare", "timeless"];
export declare const RECALL_QUERY_GRANULARITIES: readonly ["summary", "exact_detail"];
export declare const RECALL_QUERY_REFERENTIAL_MODES: readonly ["anchored", "deictic"];
export declare const RECALL_QUERY_EVIDENCE_NEEDS: readonly ["workflow_context", "canonical_state", "factual_history", "event_history", "relation", "chunk"];
export declare const TURN_MODES: readonly ["memory_qa", "workspace_task", "mixed"];
export declare const RECALL_NEED_LEVELS: readonly ["none", "background_only", "shallow", "full"];
export declare const WORKING_PROJECTION_ROLES: readonly ["user_style", "active_task", "active_blocker", "validated_strategy", "open_risk"];
export declare const MEMORY_ACTIONS: readonly ["ignore", "session_state", "durable_state", "stable_fact", "episodic_event", "graph_relation"];
export declare const MEMORY_SIGNAL_TYPES: readonly ["self_consistency", "retrieval_support", "future_usefulness", "outcome_feedback", "contradiction", "temporal_stability", "assistant_grounding", "demotion", "promotion", "correction", "repeated_use", "stale_decay"];
export declare const MEMORY_SIGNAL_TARGET_KINDS: readonly ["state", "task", "fact", "event", "graph_edge", "chunk"];
export declare const MEMORY_BELIEF_STAGES: readonly ["candidate", "probationary", "active", "decaying", "superseded", "quarantined"];
export declare const ABSTRACTION_CANDIDATE_TYPES: readonly ["derived_state", "workflow_pattern", "concept_candidate", "graph_hypothesis", "outcome_hypothesis"];
export declare const ABSTRACTION_CANDIDATE_STAGES: readonly ["candidate", "probationary", "active", "decaying", "superseded", "quarantined"];
export declare const STRATEGY_HYPOTHESIS_STAGES: readonly ["candidate", "active", "superseded", "quarantined"];
export declare const MEMORY_BELIEF_KINDS: readonly ["state", "task", "fact", "event", "graph_edge", "chunk", "strategy"];
export declare const GRAPH_RELATION_TYPES: readonly ["depends_on", "blocks", "caused_by", "uses", "part_of", "owner_of", "supersedes", "contradicts", "resolved_by", "related_to", "reads"];
export declare const GRAPH_SUPPORT_RELATION_TYPES: readonly ["supported_by", "derived_from", "updates", "targets"];
export declare const ENTITY_TYPES: readonly ["person", "project", "tool", "service", "language", "framework", "concept", "organization", "unknown"];
export declare const GRAPH_NODE_KINDS: readonly ["entity", "task", "state", "fact", "event", "outcome"];
export declare const MEMORY_CLASSES: readonly ["current-state", "stable-fact", "episodic-event", "graph-worthy", "ignore"];
export declare const MEMORY_SOURCE_KINDS: readonly ["user", "assistant", "tool"];
export declare const MEMORY_SCOPE_TEMPLATES: readonly ["global", "agent:{agentId}", "session:{sessionKey}", "project:{project}"];
export declare const MEMORY_PII_MODES: readonly ["off", "redact", "allow"];
export declare const MEMORY_CONSENT_MODES: readonly ["explicit", "implicit", "off"];
export declare const MEMORY_EMBEDDING_PROVIDERS: readonly ["off", "openai-compatible", "ollama", "sentence-transformers-local"];
...
export declare const MEMX_STATE_LIFECYCLE_KINDS: readonly ["durable_profile", "session_working", "transient_blocker", "transient_next_step", "derived_maintenance", "task_checkpoint"];
...
export type MemoryGuidanceType = "language" | "style" | "charset" | "output_order" | "generic_preference";
...
export type MemoryCanonicalKind = "state" | "fact" | "event" | "entity" | "graph_edge" | "task" | "chunk";
export type MemoryLineageSourceKind = "chunk" | "task" | "state" | "fact" | "event" | "entity_alias" | "graph_edge" | "vector_doc" | "alternate";
...
export type MaintenanceAuthoritySource = "deterministic_aggregated" | "llm_confirmed" | "llm_upgrade" | "embedding_clustered";
export type MaintenanceSemanticSource = "upstream_structured" | "embedding_clustered" | "llm_upgrade" | "deterministic_lifecycle" | "lexical_fallback";
export type MemoryLlmCallStage = "query_hot_path" | "write_hot_path" | "post_answer_writeback" | "maintenance_async";
...
export type TurnSemanticAssertionFamilyHint = "workflow" | "preference" | "fact_like" | "event_like" | "relation_like" | "strategy_like";
...
export type EntityResolutionMethod = "exact" | "alias" | "project_identity" | "cooccurrence" | "embedding_candidate" | "llm_candidate" | "identity_link" | "new_entity" | "uncertain";
export type EntityIdentityLinkType = "same_as" | "duplicate_of" | "possible_same_as" | "supersedes";
export type EntityMentionSemanticRole = "subject" | "object" | "resource" | "project" | "person" | "query" | "support";
...
export type QueryAnswerMode = "single_fact" | "attribute_lookup" | "count_aggregate" | "multi_evidence";
...
export type CandidateSurface = "state" | "fact" | "event" | "task" | "chunk" | "graph" | "entity_alias";
...
export type EvidencePlanLayer = CandidateSurface | "control" | "strategy" | "abstraction" | "belief" | "snippet";
...
export type QueryEvidenceOperationType = "return_value" | "aggregate" | "derive" | "compare" | "relate" | "tailor_advice";
...
export type RecallQualityGateDecisionKind = "accept_full" | "downgrade_background" | "reroute" | "retry_shallow";
...
export type EvidenceUnitRole = "answer_value" | "answer_event" | "query_context" | "time_constraint" | "user_resource" | "prior_advice" | "support";
export type EvidenceUnitOrigin = "raw_chunk" | "canonical_fact" | "event" | "state" | "graph" | "belief" | "strategy" | "derived_summary" | "snippet";
export type SourceRefKind = "turn" | "chunk" | "event" | "fact" | "state" | "graph_edge" | "entity" | "belief" | "strategy" | "abstraction_candidate" | "task" | "query" | "prompt_line";
...
export declare const MEMORY_OBJECT_KINDS: readonly ["state", "task", "fact", "event", "graph_path", "chunk", "alternate"];
...
export type ConversationTaskPhase = "investigating" | "proposed" | "attempting" | "validated" | "resolved" | "reopened";
...
export type MemoryOperationContext = Required<Pick<PluginActorContext, "agentId">> & PluginActorContext & {
